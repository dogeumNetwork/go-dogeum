...
import (
	...
	"github.com/dogeum-network/go-dogeum/common/math"
	...
	"github.com/dogeum-network/go-dogeum/crypto"
	"github.com/dogeum-network/go-dogeum/ethdb"
	"github.com/dogeum-network/go-dogeum/log"
	"github.com/dogeum-network/go-dogeum/params"
...
func DefaultGenesisBlock() *Genesis {
	return &Genesis{
		...
		Nonce:      66,
		ExtraData:  hexutil.MustDecode("0x7e72c17cf9a60d3f822bfc4d526756a7269fcc79efed09a44acd43aa10273425"), // input value: popcat(keccak-256)
		GasLimit:   8000000,                                                                                  // 5000 --> 8000000
		Difficulty: big.NewInt(17179),                                                                        // 17179869184 --> 17179

...
import (
	...
	"github.com/dogeum-network/go-dogeum/consensus"
	"github.com/dogeum-network/go-dogeum/consensus/misc"
...
var (
	...
	PopcatBlockReward, _          = big.NewInt(0).SetString("50000000000000000000", 10) // Popcat Block Reward
